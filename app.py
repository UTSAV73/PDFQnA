...
tok = os.path.join(currdir, 'token.json')
scb = os.path.join(currdir, 'secure-connect-pdfreader.zip')
...
def main():
    ...
    os.environ['OPENAI_API_KEY'] = "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"
